...
cohort$inputs$bolus$C1o$TIME                = c() # hour 
cohort$inputs$bolus$C1o$AMT                 = c() # mg/L 
cohort$inputs$bolus$C2o$TIME                = c() # hour 
cohort$inputs$bolus$C2o$AMT                 = c() # mg/L 
cohort$inputs$bolus$C2d$TIME                = c() # hour 
cohort$inputs$bolus$C2d$AMT                 = c() # mg/L 
cohort$inputs$bolus$C3d$TIME                = c() # hour 
cohort$inputs$bolus$C3d$AMT                 = c() # mg/L 
cohort$inputs$bolus$Ato$TIME                = c() # hour 
cohort$inputs$bolus$Ato$AMT                 = c() # mg 
cohort$inputs$bolus$Atd$TIME                = c() # hour 
cohort$inputs$bolus$Atd$AMT                 = c() # mg 
