...
## Group 1 Level 1
load("../Concentrations/30dacoQD_80osiBID.RData")
...
start = Sys.time()
group2.3Count = lapply(1:N, appFunc, drugConc = group2.3)
group2.3Count = bind_rows(group2.3Count)
Sys.time()-start
save(group2.3Count, file = "../Results/30dacoQD_80osiBID.RData")
