...
## Group 1 Level 1
load("../Concentrations/30dacoQD_80osiQD.RData")
...
start = Sys.time()
group1.2Count = lapply(1:N, appFunc, drugConc = group1.2) 
group1.2Count = bind_rows(group1.2Count)
Sys.time()-start
save(group1.2Count, file = "../Results/30dacoQD_80osiQD.RData")
