...
## Group 1 Level 1
load("../Concentrations/15dacoQD_40osiBID.RData")
...
start = Sys.time()
group2.1Count = lapply(1:N, appFunc, drugConc = group2.1)
group2.1Count = bind_rows(group2.1Count)
Sys.time()-start
save(group2.1Count, file = "../Results/15dacoQD_40osiBID.RData")
