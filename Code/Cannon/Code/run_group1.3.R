...
## Group 1 Level 1
load("../Concentrations/45dacoQD_80osiQD.RData")
...
start = Sys.time()
group1.3Count = lapply(1:N, appFunc, drugConc = group1.3)
group1.3Count = bind_rows(group1.3Count)
Sys.time()-start
save(group1.3Count, file = "../Results/45dacoQD_80osiQD.RData")
