...
## Group 1 Level 1
load("../Concentrations/15dacoQD_40osiQD.RData")
...
start = Sys.time()
group1_1Count = lapply(1:N, appFunc, drugConc = group1_1)
group1_1Count = bind_rows(group1_1Count)
Sys.time()-start
save(group1_1Count, file = "../Results/15dacoQD_40osiQD.RData")
