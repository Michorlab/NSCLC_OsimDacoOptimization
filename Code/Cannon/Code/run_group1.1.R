...
## Group 1 Level 1
load("../Concentrations/30dacoQD_40osiQD.RData")
...
start = Sys.time()
group1.1Count = lapply(1:N, appFunc, drugConc = group1.1)
group1.1Count = bind_rows(group1.1Count)
Sys.time()-start
save(group1.1Count, file = "../Results/30dacoQD_40osiQD.RData")
